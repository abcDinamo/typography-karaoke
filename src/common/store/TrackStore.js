...
trackStore.addTrack(new Track('Frere Jacques', 'Frere Jacques', alphabetTrack, alphabetSubtitles));
trackStore.addTrack(new Track('If you are Happy', 'If you are Happy', alphabetTrack, alphabetSubtitles));
